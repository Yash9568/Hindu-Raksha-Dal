...
export default function MembershipPage() {
  ...
  async function handleDownloadPDF() {
    try {
      ...
      const pdfW = canvas.width; // in px
      const pdfH = canvas.height; // in px
    ...
    <section className="bg-white rounded-lg shadow p-6">
      ...
      <form className="grid md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-2 flex gap-3 flex-wrap">
          ...
          <button type="button" className="border border-[#FF9933] text-[#FF9933] px-4 py-2 rounded" onClick={handleDownloadPNG}>
            Download PNG
          </button>
          <button type="button" className="border border-[#FF9933] text-[#FF9933] px-4 py-2 rounded" onClick={handleDownloadPDF}>
            Download PDF
          </button>
          ...
          <div className="p-3 relative z-10 h-full flex gap-3">
            ...
            <div className="flex-1 text-xs relative">
              <div className="flex items-center justify-between">
                <div className="font-bold text-[#FF9933]">Hindu Raksha Dal</div>
              ...
              <div className="absolute bottom-2 left-0 text-[10px] text-gray-500" suppressHydrationWarning>
                Issued: {mounted ? (issued || "") : ""}
              </div>
            </div>
          </div>
        </div>
